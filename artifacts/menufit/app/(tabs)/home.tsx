...
const styles = StyleSheet.create({
  ...
  nextVisual: { width: 125, height: 132, alignItems: 'center', justifyContent: 'center', position: 'relative' },
  nextVisualDot: { width: 12, height: 12, borderRadius: 6, position: 'absolute', right: 18, top: 18 },

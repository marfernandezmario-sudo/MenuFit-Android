...
export default function HomeScreen() {
  ...
  return <ScrollView style={{ backgroundColor: colors.background }} contentContainerStyle={[styles.content, { paddingTop: insets.top + 12, paddingBottom: insets.bottom + 100 }]} showsVerticalScrollIndicator={false}>
    <View style={styles.header}><View><Text style={[styles.greeting, { color: colors.mutedForeground }]}>Buenos días</Text><Text style={[styles.title, { color: colors.foreground }]}>Tu semana, más fácil.</Text></View><IconButton icon="settings" onPress={() => router.push('/(tabs)/profile')} label="Abrir ajustes" /></View>

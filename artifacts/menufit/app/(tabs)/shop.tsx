...
import { Field, PrimaryButton, SectionTitle } from '@/components/MenuFitUI';

export default function ShopScreen() {
  const colors = useColors();
  const insets = useSafeAreaInsets();
  const { shopping, toggleShoppingItem, clearPurchased, addShoppingItem, getShoppingWindowDays, preferences } = useMenuFit();

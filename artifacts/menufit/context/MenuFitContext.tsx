...
export const recipes: Recipe[] = [
  ...
  {
    id: 'homemade-burger',
    name: 'Hamburguesa casera con patatas al horno',
    mealType: 'Comida',
    time: 30,
    prepTime: 10,
    cookTime: 20,
    ...
    image: imageAssets.chicken,
    ingredients: [
      { name: 'carne picada de ternera', amount: 160, unit: 'g', category: 'Carne' },
      { name: 'pan de hamburguesa integral', amount: 1, unit: 'ud', category: 'Cereales' },
      { name: 'patata', amount: 180, unit: 'g', category: 'Verduras' },
      { name: 'lechuga', amount: 30, unit: 'g', category: 'Verduras' },
      { name: 'tomate', amount: 60, unit: 'g', category: 'Verduras' },
    ],
    steps: ['Forma la hamburguesa con la carne picada, sal y pimienta.', 'Corta la patata en gajos y hornéala con un poco de aceite durante 20 minutos.', 'Cocina la hamburguesa a la plancha 4-5 minutos por cada lado.', 'Monta el pan con la lechuga, el tomate y la hamburguesa y sirve con las patatas.'],
    calories: 620,
    protein: 38,
    carbs: 61,
    fats: 25,
    tags: ['casero', 'alto en proteína'],
    description: 'Una hamburguesa de toda la vida, hecha en casa y acompañada de patatas al horno.',
  },
  {
    id: 'homemade-meatballs',
    name: 'Albóndigas caseras con arroz',
    mealType: 'Cena',
    time: 30,
    prepTime: 12,
    cookTime: 18,
    ...
    ingredients: [
      { name: 'carne picada de ternera', amount: 160, unit: 'g', category: 'Carne' },
      { name: 'huevo', amount: 0.5, unit: 'ud', category: 'Huevos' },
      { name: 'pan rallado', amount: 20, unit: 'g', category: 'Cereales' },
      { name: 'tomate triturado', amount: 180, unit: 'g', category: 'Verduras' },
      { name: 'arroz', amount: 60, unit: 'g', category: 'Cereales' },
    ],
    steps: ['Mezcla la carne con el huevo, el pan rallado, sal y pimienta y forma las albóndigas.', 'Dóralas en una cazuela con un poco de aceite.', 'Añade el tomate triturado y cocina tapado durante 15 minutos.', 'Cuece el arroz y sirve las albóndigas con la salsa por encima.'],
    calories: 590,
    protein: 39,
    carbs: 58,
    fats: 22,
    tags: ['casero', 'batch cooking', 'alto en proteína'],
    description: 'Un plato familiar y reconfortante que queda perfecto para llevar al día siguiente.',
  },
  {
    id: 'pasta-bolognese',
    ...
    image: imageAssets.chicken,
    ingredients: [
      { name: 'pasta', amount: 80, unit: 'g', category: 'Cereales' },
      { name: 'carne picada de ternera', amount: 130, unit: 'g', category: 'Carne' },
      { name: 'tomate triturado', amount: 180, unit: 'g', category: 'Verduras' },
      { name: 'cebolla', amount: 60, unit: 'g', category: 'Verduras' },
      { name: 'queso parmesano', amount: 15, unit: 'g', category: 'Lácteos' },
    ],
    steps: ['Pica la cebolla y sofríela hasta que esté transparente.', 'Añade la carne y cocina hasta que cambie de color.', 'Incorpora el tomate y deja que la salsa reduzca durante 15 minutos.', 'Cuece la pasta, mézclala con la salsa y termina con parmesano.'],
    calories: 610,
    protein: 35,
    carbs: 76,
    fats: 19,
    tags: ['casero', 'favorito'],
    description: 'El clásico plato de pasta con salsa de tomate y carne preparado en casa.',
  },
  {
    ...
    ingredients: [
      { name: 'patata', amount: 220, unit: 'g', category: 'Verduras' },
      { name: 'huevos', amount: 2, unit: 'ud', category: 'Huevos' },
      { name: 'cebolla', amount: 50, unit: 'g', category: 'Verduras' },
      { name: 'lechuga', amount: 50, unit: 'g', category: 'Verduras' },
      { name: 'tomate', amount: 80, unit: 'g', category: 'Verduras' },
    ],
    steps: ['Corta la patata y la cebolla y cocínalas a fuego medio hasta que estén tiernas.', 'Bate los huevos y mezcla con la patata y la cebolla.', 'Cuaja la tortilla en una sartén y dale la vuelta con cuidado.', 'Acompaña con lechuga y tomate aliñados.'],
    calories: 480,
    protein: 21,
    carbs: 48,
    fats: 23,
    tags: ['vegetariano', 'casero', 'sin gluten'],
    description: 'Una tortilla española sencilla acompañada de una ensalada fresca.',
  },
  {
    id: 'chicken-potatoes',
    ...
    image: imageAssets.chicken,
    ingredients: [
      { name: 'contramuslo de pollo', amount: 180, unit: 'g', category: 'Carne' },
      { name: 'patata', amount: 180, unit: 'g', category: 'Verduras' },
      { name: 'zanahoria', amount: 80, unit: 'g', category: 'Verduras' },
      { name: 'cebolla', amount: 60, unit: 'g', category: 'Verduras' },
      { name: 'limón', amount: 0.5, unit: 'ud', category: 'Frutas' },
    ],
    steps: ['Corta la patata, la zanahoria y la cebolla y colócalas en una bandeja.', 'Añade el pollo, sal, pimienta, aceite y el zumo de limón.', 'Hornea durante 20-22 minutos, hasta que el pollo esté bien cocinado.', 'Sirve el pollo con las verduras asadas.'],
    calories: 540,
    protein: 42,
    carbs: 43,
    fats: 22,
    tags: ['casero', 'alto en proteína', 'sin gluten'],
    description: 'Una bandeja de horno práctica, sabrosa y con ingredientes de diario.',
  },
  {
    id: 'chicken-rice',
    ...
    image: imageAssets.chicken,
    ingredients: [
      { name: 'pechuga de pollo', amount: 150, unit: 'g', category: 'Carne' },
      { name: 'arroz', amount: 70, unit: 'g', category: 'Cereales' },
      { name: 'pimiento rojo', amount: 70, unit: 'g', category: 'Verduras' },
      { name: 'guisantes', amount: 60, unit: 'g', category: 'Verduras' },
      { name: 'cebolla', amount: 50, unit: 'g', category: 'Verduras' },
    ],
    steps: ['Sofríe la cebolla y el pimiento picados.', 'Añade el pollo en dados y dóralo.', 'Incorpora el arroz y los guisantes y remueve un minuto.', 'Añade el agua o caldo y cocina hasta que el arroz esté tierno.'],
    calories: 560,
    protein: 39,
    carbs: 69,
    fats: 13,
    tags: ['casero', 'batch cooking', 'alto en proteína'],
    description: 'Un arroz completo y fácil de preparar con pollo y verduras.',
  },
  {
    ...
    image: imageAssets.quinoa,
    ingredients: [
      { name: 'pasta', amount: 70, unit: 'g', category: 'Cereales' },
      { name: 'pechuga de pollo', amount: 130, unit: 'g', category: 'Carne' },
      { name: 'tomate cherry', amount: 100, unit: 'g', category: 'Verduras' },
      { name: 'maíz', amount: 50, unit: 'g', category: 'Verduras' },
      { name: 'lechuga', amount: 50, unit: 'g', category: 'Verduras' },
    ],
    steps: ['Cuece la pasta y enfríala bajo el grifo.', 'Cocina el pollo a la plancha y córtalo en tiras.', 'Mezcla la pasta con el pollo, el tomate, el maíz y la lechuga.', 'Aliña con aceite, limón, sal y pimienta.'],
    calories: 500,
    protein: 36,
    carbs: 61,
    fats: 14,
    tags: ['casero', 'fresco', 'batch cooking'],
    description: 'Una ensalada completa y fácil de dejar preparada para comer fuera.',
  },
  {
    id: 'country-salad',
    ...
    ingredients: [
      { name: 'patata', amount: 220, unit: 'g', category: 'Verduras' },
      { name: 'huevos', amount: 2, unit: 'ud', category: 'Huevos' },
      { name: 'tomate', amount: 120, unit: 'g', category: 'Verduras' },
      { name: 'pimiento verde', amount: 60, unit: 'g', category: 'Verduras' },
      { name: 'aceitunas', amount: 25, unit: 'g', category: 'Otros' },
    ],
    steps: ['Cuece las patatas y los huevos hasta que estén hechos.', 'Deja templar, pela y corta las patatas y los huevos.', 'Añade el tomate, el pimiento y las aceitunas.', 'Aliña con aceite de oliva, vinagre, sal y pimienta.'],
    calories: 430,
    protein: 18,
    carbs: 47,
    fats: 20,
    tags: ['vegetariano', 'casero', 'sin gluten'],
    description: 'Una ensalada de patata tradicional, fresca y muy saciante.',
  },
  {
    id: 'vegetable-pasta-salad',
    ...
    image: imageAssets.quinoa,
    ingredients: [
      { name: 'pasta', amount: 75, unit: 'g', category: 'Cereales' },
      { name: 'tomate cherry', amount: 100, unit: 'g', category: 'Verduras' },
      { name: 'pepino', amount: 80, unit: 'g', category: 'Verduras' },
      { name: 'maíz', amount: 60, unit: 'g', category: 'Verduras' },
      { name: 'aceitunas', amount: 20, unit: 'g', category: 'Otros' },
    ],
    steps: ['Cuece la pasta y enfríala.', 'Corta el tomate y el pepino.', 'Mezcla todos los ingredientes con el maíz y las aceitunas.', 'Aliña con aceite, limón, sal y orégano.'],
    calories: 390,
    protein: 12,
    carbs: 65,
    fats: 11,
